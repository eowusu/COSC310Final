...
public class Matcher {
    ...
    /**
     * This method uses the private methods to take a sentence in the form of a String
     ...
     * @param str the sentence that need to be corrected
     * @return the sentence with all words changed to words recognized from text files
     */
